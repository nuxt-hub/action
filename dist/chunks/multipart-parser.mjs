import 'node:fs';
import 'node:path';
import { Z as Zt, Y as Yr } from '../index.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
